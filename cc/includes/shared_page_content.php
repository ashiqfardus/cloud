...
while ($row=mysqli_fetch_array($query))
{
    ...
    {
        $page_id=$_GET['id'];
        $sql="SELECT * FROM shared WHERE id='$page_id'";
        ...
        while ($row=mysqli_fetch_array($run))
        {
            ...
            <div class="header_text2">
                ...
                <div class="row row_margin_h">
                    <a href="delete_share.php?del=<?php echo $file_id;?>"><button  type="button" class="btn btn-danger">Delete</button></a>
                    <a href="download.php?id=<?php echo $post_image;?>"><button  type="button" class="btn btn-primary">Download</button></a>
                </div>
            </div>
            </div>
        <?php }}} ?>