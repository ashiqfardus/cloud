...
<div class="col-md-7 ">
    ...
    <?php
    $select_posts="SELECT * FROM data where username='$username' order by date DESC LIMIT 12 ";
    ...
    while($row=mysqli_fetch_array($run_posts)){
        ...
        <div class="col-md-3 content_margin">
            <div class="div_border3 " >
                ...
                <figcaption style=" font-size:10px; text-align: center; text-transform: capitalize;font-weight: ;"> Modified Date-<?php echo substr($date,0,10); ?></figcaption>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                            <a href="pages.php?id=<?php echo $file_id;?>"><button  type="button" class="btn btn-primary">Open In New Window</button></a>
                            <a href="remove.php?del=<?php echo $file_id;?>"><button  type="button" class="btn btn-danger">Remove</button></a>
